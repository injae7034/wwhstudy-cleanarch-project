...
## 3.1 기재하기 예외 화면1(이름, 주소, 전화번호는 필수, 이메일 선택)
...
## 5.1 수정하기 예외 화면1(주소, 전화번호는 필수, 이메일 선택)  
...
## 7.1 홈화면에 정렬하기 체크박스 선택되어 있는 상태에서 기재하기 화면으로 이동
...
기재하기 화면으로 이동한 다음 **새로운 개인 정보를 기재**한 다음 기재하기 버튼을 클릭하면  
...
## 7.2 홈화면에 정렬하기 체크박스 선택되어 있는 상태에서 기재했을 때 실제 데이터베이스 저장 순서
